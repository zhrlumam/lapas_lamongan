...
<head>
    ...
    <style>
        :root {
            --midnight-blue: #07213D; /* Warna Standar  */
            --gold-dignity: #EEBF63;  /* Warna Standar  */
            --platinum: #E0E2E3;      /* Warna Standar [cite: 9, 10, 41] */
        }

        body {
            font-family: 'Titillium Web', sans-serif; /* Kewajiban Font  */
        ...
        .login-card {
            ...
            border-top: 5px solid var(--gold-dignity); /* Aksen Gold  */
        }

        .card-header {
            background-color: var(--midnight-blue); /* Midnight Blue  */
            padding: 30px;
            text-align: center;
            color: white;
        }
        ...
        .card-header h5 {
            font-weight: 700; /* Titillium Web Bold [cite: 16] */
            margin: 0;
            letter-spacing: 1px;
            font-size: 1.1rem;
        }
        ...
        .btn-primary {
            ...
            border: none;
            font-weight: 600; /* Titillium Web Semibold [cite: 15] */
            padding: 12px;
        }
...
<div class="login-card">
    ...
    <div class="card-body p-4">
        ...
        <form method="POST" action="">
            ...
            <button type="submit" class="btn btn-primary w-100 mt-2">MASUK SISTEM</button>
        </form>
    </div>
