...
<body class="bg-white text-slate-900 antialiased font-sans flex flex-col min-h-screen">
    ...
    <main class="max-w-5xl mx-auto p-4 mt-6 flex-grow">
        ...
        <!-- Peringatan Barang Dilarang -->
        <div class="mb-10 bg-white border-2 border-red-100 rounded-[2rem] overflow-hidden shadow-sm animate-reveal delay-1">
            <div class="bg-red-600 px-6 py-4 flex items-center justify-between">
                <h3 class="text-white font-bold uppercase text-[9px] md:text-[10px] tracking-widest flex items-center gap-2">
                    <i data-lucide="shield-alert" class="w-4 h-4"></i> Larangan Membawa Barang Terlarang
                </h3>
            </div>
            <div class="p-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-4 text-center">
                <div class="flex flex-col items-center gap-2">
                    <div class="w-14 h-14 md:w-16 md:h-16 bg-red-50 text-red-600 flex items-center justify-center rounded-2xl">
                        <i data-lucide="smartphone" class="w-6 h-6 md:w-8 md:h-8"></i>
                    </div>
                    <span class="text-[9px] font-bold uppercase text-slate-500 tracking-tighter">Handphone</span>
                </div>
                <div class="flex flex-col items-center gap-2">
                    <div class="w-14 h-14 md:w-16 md:h-16 bg-red-50 text-red-600 flex items-center justify-center rounded-2xl">
                        <i data-lucide="pill" class="w-6 h-6 md:w-8 md:h-8"></i>
                    </div>
                    <span class="text-[9px] font-bold uppercase text-slate-500 tracking-tighter">Narkoba</span>
                </div>
                <div class="flex flex-col items-center gap-2">
                    <div class="w-14 h-14 md:w-16 md:h-16 bg-red-50 text-red-600 flex items-center justify-center rounded-2xl">
                        <i data-lucide="sword" class="w-6 h-6 md:w-8 md:h-8"></i>
                    </div>
                    <span class="text-[9px] font-bold uppercase text-slate-500 tracking-tighter">Senpi/Sajam</span>
                </div>
                <div class="flex flex-col items-center gap-2">
                    <div class="w-14 h-14 md:w-16 md:h-16 bg-red-50 text-red-600 flex items-center justify-center rounded-2xl">
                        <i data-lucide="wallet" class="w-6 h-6 md:w-8 md:h-8"></i>
                    </div>
                    <span class="text-[9px] font-bold uppercase text-slate-500 tracking-tighter">Uang Tunai</span>
                </div>
            </div>
            <div class="px-6 py-4 bg-red-50 text-center">
                <p class="text-[10px] text-red-700 font-bold uppercase italic leading-tight">* Barang terlarang wajib dititipkan di petugas loket penitipan resmi.</p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="w-full max-w-sm">
                ...
                <div class="mt-4 flex flex-col gap-2">
                    ...
                    <button onclick="showFeedbackPopup('Kunjungan')"
                        class="w-full bg-white/10 text-white py-4 rounded-2xl font-bold text-xs uppercase border border-white/20 hover:bg-white/20 transition-all">Selesai & Beri Penilaian</button>
                </div>
            </div>
            </div>
        <?php endif; ?>
