...
// 2. KEAMANAN: Header Proteksi Profesional
...
<head>
    ...
    <title>Profil Instansi - Lapas Kelas IIB Lamongan</title>
    <meta name="description" content="Kunjungi profil resmi Lembaga Pemasyarakatan Kelas IIB Lamongan. Pelajari sejarah, visi, misi, dan struktur organisasi pimpinan kami.">
...
<body class="bg-slate-50 text-slate-900 antialiased">
    ...
    <?php if (file_exists("layout/navbar.php"))
        include "layout/navbar.php"; ?>

    <section class="pt-24 pb-20 hero-gradient text-white px-6 relative overflow-hidden">
        <div class="absolute top-0 right-0 w-64 h-64 bg-imipas-gold opacity-5 rounded-full -mr-32 -mt-32 blur-3xl">
        </div>
        <div class="max-w-7xl mx-auto relative z-10" data-aos="fade-up">
            ...
            <h1 class="text-4xl md:text-6xl font-bold uppercase tracking-tight leading-tight mb-4">Mengenal Lapas
                <br><span class="text-imipas-gold">Kelas IIB Lamongan</span></h1>
            <p class="text-imipas-platinum/70 text-sm md:text-base max-w-2xl leading-relaxed">Institusi pemasyarakatan
                yang menjunjung tinggi nilai integritas, transparansi, dan pemenuhan hak asasi manusia.</p>
        </div>
    </section>
                ...
                <div class="grid md:grid-cols-2 items-stretch">
                    <div class="aspect-[3/4] md:aspect-auto overflow-hidden bg-slate-100 relative">
                        ...
                        if (!file_exists($foto_path))
                            $foto_path = "assets/images/default.jpg";
                        ?>
                        <img src="<?= $foto_path ?>"
                    ...
                    <div class="p-8 md:p-12 flex flex-col justify-center">
                        <div class="mb-6">
                            <h4 class="text-imipas-blue font-bold uppercase text-2xl tracking-tighter leading-none">
                                <?= e($profil['nama_kepala']) ?></h4>
                            <p class="text-imipas-gold text-xs font-bold uppercase tracking-[0.2em] mt-2">
                                <?= e($profil['jabatan_kepala']) ?></p>
                        </div>
                        <div class="relative">
                            <svg class="absolute -top-4 -left-4 w-8 h-8 text-slate-100 z-0" fill="currentColor"
                                viewBox="0 0 32 32">
    ...
    <section class="py-20 px-4 max-w-7xl mx-auto overflow-hidden">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div class="lg:col-span-5 order-2 lg:order-1" data-aos="fade-right">
                <div class="relative">
                    <div class="absolute -top-4 -left-4 w-full h-full border-4 border-imipas-gold/20 rounded-lg -z-10">
                    </div>
                    <img src="assets/images/hero.jpg" class="w-full h-[450px] object-cover shadow-2xl rounded-lg"
                        alt="Gedung Lapas">
                </div>
            </div>
            ...
            <div class="lg:col-span-7 order-1 lg:order-2" data-aos="fade-left">
                ...
                <h3 class="text-3xl md:text-5xl font-bold text-imipas-blue mb-8 uppercase tracking-tighter">Dedikasi
                    Untuk <span class="text-imipas-gold">Negara</span></h3>
    ...
    <section class="py-24 px-4 bg-white border-t border-slate-100 overflow-hidden">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="group p-10 border border-slate-100 bg-slate-50 hover:bg-imipas-blue transition-all duration-500 rounded-xl shadow-sm"
                    data-aos="fade-up" data-aos-delay="100">
                    <div class="w-12 h-12 bg-imipas-gold flex items-center justify-center rounded-lg mb-6 shadow-lg">
                        <svg class="w-6 h-6 text-imipas-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h5
                        class="text-imipas-blue group-hover:text-imipas-gold font-bold uppercase tracking-widest mb-4 text-xl">
                        Visi</h5>
                    <p class="text-slate-600 group-hover:text-slate-200 italic leading-relaxed text-lg">
                        "<?= e($profil['visi']) ?>"</p>
                </div>
    ...
    <section class="py-24 px-4 bg-slate-50 border-t border-slate-100 overflow-hidden">
        <div class="max-w-7xl mx-auto">
            <div class="text-center mb-16" data-aos="fade-up">
                <h2 class="text-imipas-blue text-4xl font-bold uppercase tracking-tighter">Struktur Organisasi</h2>
                <div class="w-20 h-1.5 bg-imipas-gold mx-auto mt-4"></div>
            </div>

            <div class="flex justify-center" data-aos="zoom-in">
                <div class="bg-white p-4 rounded-xl shadow-lg border border-slate-200 max-w-5xl w-full">
                    <img src="assets/images/struktur.jpeg" class="w-full h-auto rounded-lg"
                        alt="Struktur Organisasi Lapas Kelas IIB Lamongan">
                </div>
            </div>
        </div>
    </section>
    ...
    <?php
    if (file_exists("layout/lokasi.php"))
        include "layout/lokasi.php";
