<?php
// 1. Tampilkan Error untuk melacak masalah (Matikan di produksi)
...
// 2. Ambil Data Profil
$query = mysqli_query($conn, "SELECT * FROM profil_lapas LIMIT 1");
...
<body class="bg-slate-50 text-slate-900 antialiased">
    ...
    <section class="pt-20 pb-20 hero-gradient text-white px-6 relative overflow-hidden">
    ...
    <section class="py-16 px-4 max-w-7xl mx-auto -mt-10 relative z-20">
        <div class="max-w-4xl mx-auto" data-aos="fade-up">
            <div class="bg-white border border-slate-200 overflow-hidden shadow-xl rounded-xl hover:border-imipas-gold transition-all duration-500">
                <div class="grid md:grid-cols-2 items-stretch">
                    <div class="aspect-[3/4] md:aspect-auto overflow-hidden bg-slate-100 relative">
                        <?php 
                            $foto = "assets/images/" . $profil['foto_kepala'];
                            if (!file_exists($foto) || empty($profil['foto_kepala'])) $foto = "assets/images/default.jpg";
                        ?>
                        <img src="<?= $foto ?>" class="w-full h-full object-cover transition duration-700 hover:scale-105" alt="Kepala Lapas">
                    </div>
                    <div class="p-10 flex flex-col justify-center">
                        <div class="mb-6">
                            <h4 class="text-imipas-blue font-bold uppercase text-2xl tracking-tighter leading-none"><?= htmlspecialchars($profil['nama_kepala']) ?></h4>
                            <p class="text-imipas-gold text-xs font-bold uppercase tracking-[0.2em] mt-2"><?= htmlspecialchars($profil['jabatan_kepala']) ?></p>
                        </div>
                        <div class="relative">
                            ...
                            <p class="text-slate-600 text-sm md:text-base italic leading-relaxed relative z-10">
                                "<?= htmlspecialchars($profil['sambutan_kepala']) ?>"
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-20 px-4 max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-7 order-1 lg:order-2" data-aos="fade-left">
                ...
                <div class="prose prose-slate max-w-none text-slate-600 leading-relaxed text-base text-justify">
    ...
    <section class="py-24 px-4 bg-white border-t border-slate-100">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div class="group p-10 border border-slate-100 bg-slate-50 hover:bg-imipas-blue transition-all duration-500 rounded-xl shadow-sm" data-aos="fade-right">
                    ...
                    <p class="text-slate-600 group-hover:text-slate-200 italic leading-relaxed text-lg">"<?= htmlspecialchars($profil['visi']) ?>"</p>
                </div>

                <div class="group p-10 border border-slate-100 bg-slate-50 hover:bg-imipas-blue transition-all duration-500 rounded-xl shadow-sm" data-aos="fade-left">
                    <div class="w-12 h-12 bg-imipas-gold flex items-center justify-center rounded-lg mb-6 shadow-lg">
