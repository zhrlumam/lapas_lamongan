...
@section('content')
    ...
    <div class="bg-soft-grey py-20 px-6" x-data="{ imgModal : false, imgModalSrc : '', imgModalDesc : '' }">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group bg-white border border-platinum p-4 rounded-sm hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all overflow-hidden cursor-pointer" 
                     @click="imgModal = true; imgModalSrc = '{{ $item->gambar_url }}'; imgModalDesc = '{{ $item->judul }}'">
                    <div class="aspect-square bg-platinum mb-6 overflow-hidden relative">
        ...
        <div x-show="imgModal" 
             ...
             class="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-midnight-blue/90 backdrop-blur-sm">
            ...
            <div @click.away="imgModal = false" class="relative max-w-5xl w-full max-h-[90vh] flex flex-col items-center">
                ...
                <img :src="imgModalSrc" class="max-w-full max-h-[80vh] object-contain rounded shadow-2xl border-4 border-white/10">
